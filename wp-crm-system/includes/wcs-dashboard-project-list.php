...
function wp_crm_system_ajax_project_list() {
	...
	<?php
		...
		<tr>
			<td>
				<span class="wpcrm-system-help-tip dashicons dashicons-clipboard wpcrm-dashicons" title="<?php esc_html_e( 'Project Name', 'wp-crm-system' ); ?>"></span>
			</td>
			<td>
				<a href="<?php echo esc_url( get_edit_post_link( $project_id ) ); ?>"><?php echo esc_attr( trim( $title ) ); ?></a>
			</td>
		</tr>
		<?php }
		if ( '' != trim( $value ) ){ ?>
		<tr>
			<td>
				<span class="wpcrm-system-help-tip dashicons dashicons-chart-line wpcrm-dashicons" title="<?php esc_html_e( 'Project Value', 'wp-crm-system' ); ?>"></span>
			</td>
			<td>
		...
		<tr>
			<td>
				<span class="wpcrm-system-help-tip dashicons dashicons-admin-tools wpcrm-dashicons" title="<?php esc_html_e( 'Project Status', 'wp-crm-system' ); ?>"></span>
			</td>
			<td>
				<?php echo esc_html( wpcrm_system_display_status( trim( $project_info['2'] ) ) ); ?>
			</td>
		</tr>
		<?php }
		...
		<tr>
			<td>
				<span class="wpcrm-system-help-tip dashicons dashicons-forms wpcrm-dashicons" title="<?php esc_html_e( 'Progress', 'wp-crm-system' ); ?>"></span>
			</td>
			<td>
				<?php echo esc_html( wpcrm_system_display_progress( trim( $project_info['3'] ) ) ); ?>
			</td>
		</tr>
		<?php }
		if ( '' != trim( $company ) ){ ?>
		...
		<tr>
			...
			<td>
				<?php echo wp_kses_post( $user_display ); ?>
			</td>
		</tr>
		<?php } ?>
	</table>
