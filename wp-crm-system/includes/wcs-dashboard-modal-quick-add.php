...
<div class="wcs-modal quick-add-init">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h2><?php esc_html_e( 'Add new', 'wp-crm-system' ); ?></h2>
		</div>
		<div class="modal-body">
			<p class="description">
				<?php esc_html_e( 'Select type of CRM data you would like to add.', 'wp-crm-system' ); ?>
			</p>
			<p><a href="#" class="quick-add organization"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Organization', 'wp-crm-system' ); ?></p>
			<p><a href="#" class="quick-add contact"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Contact', 'wp-crm-system' ); ?></p>
			<p><a href="#" class="quick-add opportunity"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Opportunity', 'wp-crm-system' ); ?></p>
			<p><a href="#" class="quick-add project"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Project', 'wp-crm-system' ); ?></p>
			<p><a href="#" class="quick-add task"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Task', 'wp-crm-system' ); ?></p>
			<p><a href="#" class="quick-add campaign"><img src="<?php echo esc_url( WP_CRM_SYSTEM_URL . '/assets/dist/images/plus-33-256.png' ); ?>" width="16"></a><?php esc_html_e( 'Campaign', 'wp-crm-system' ); ?></p>
		</div>
	</div>
</div>
...
<div id="wcs-modal-task" class="wcs-modal wcs-task">
	<div class="modal-content">
		<div class="modal-header">
			<span class="close">&times;</span>
			<h2><?php esc_html_e( 'Add Task', 'wp-crm-system' ); ?></h2>
		</div>
		<div class="modal-body">
			<p class="message"></p>
			...
			<p>
				<label for="task_start_date"><?php esc_html_e( 'Start Date: ', 'wp-crm-system' ); ?></label>
				<input id="task_start_date" name="task_start_date" type="text" class="datepicker">
			</p>
			<p>
				<label for="due_date"><?php esc_html_e( 'Due Date: ', 'wp-crm-system' ); ?></label>
			...
			<p>
				<label for="priority"><?php esc_html_e( 'Priority: ', 'wp-crm-system' ); ?></label>
			...
			<p><input type="submit" class="button button-primary wcs-modal-submit task" value="<?php esc_html_e( 'Add', 'wp-crm-system' ); ?>"></p>
			</form>
		</div>
	</div>
</div>
...
<div  id="wcs-modal-opportunity" class="wcs-modal wcs-opportunity">
	<div class="modal-content">
		<div class="modal-header">
			<span class="close">&times;</span>
			<h2><?php esc_html_e( 'Add Opportunity', 'wp-crm-system' ); ?></h2>
		</div>
		<div class="modal-body">
			<p class="message"></p>
			...
			<p>
				<label for="oppor_date"><?php esc_html_e( 'Forecasted Close Date: ', 'wp-crm-system' ); ?><span class="wcs-required"> *</span></label>
				<input id="oppor_date" name="forecasted_close_date" type="text" class="datepicker">
			</p>
			<p>
				<label for="oppor_value"><?php esc_html_e( 'Value: ', 'wp-crm-system' ); ?><span class="wcs-required"> *</span></label>
				<input id="oppor_value" name="value" type="text" />
			</p>
			<p>
				<label for="won_lost"><?php esc_html_e( 'Won/Lost: ', 'wp-crm-system' ); ?></label>
			...
			<p><input type="submit" class="button button-primary wcs-modal-submit opportunity" value="<?php esc_html_e( 'Add', 'wp-crm-system' ); ?>"></p>
			</form>
		</div>
	</div>
</div>
